...
vc_map(
    array(
        'name'     => esc_html__('Portfolio Grid Gallery', 'induxe'),
        'base'     => 'ct_portfolio_grid_gallery',
        'class'    => 'ct-icon-element',
        'description' => esc_html__( 'Portfolio Displayed', 'induxe' ),
        'category' => esc_html__('CaseThemes Shortcodes', 'induxe'),
        'params'   => array(
            array(
                'type' => 'cms_template_img',
                'param_name' => 'cms_template',
                'shortcode' => 'ct_portfolio_grid_gallery',
                'heading' => esc_html__('Shortcode Template', 'induxe'),
                'admin_label' => true,
                'std' => 'ct_portfolio_grid_gallery.php',
...
class WPBakeryShortCode_ct_portfolio_grid_gallery extends CmsShortCode
{
    protected function content($atts, $content = null)
    {
        $html_id = cmsHtmlID('ct-portfolio-grid-gallery');
