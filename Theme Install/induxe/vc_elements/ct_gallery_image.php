<?php
$term_list = cms_get_grid_term_list('gallery');
vc_map(
    array(
        'name'     => esc_html__('Gallery Grid Image', 'induxe'),
        'base'     => 'ct_gallery_image',
        'class'    => 'ct-icon-element',
        'description' => esc_html__( 'Gallery Displayed', 'induxe' ),
        'category' => esc_html__('CaseThemes Shortcodes', 'induxe'),
        'params'   => array(
            array(
                'type' => 'cms_template_img',
                'param_name' => 'cms_template',
                'shortcode' => 'ct_gallery_image',
                'heading' => esc_html__('Shortcode Template', 'induxe'),
                'admin_label' => true,
                'std' => 'ct_gallery_image.php',
            ...
            array(
                ...
                'settings'   => array(
                    'multiple' => true,
                    'values'   => cms_get_type_posts_data('gallery')
                ),
                'dependency' => array(
                    'element'=>'custom_source',
                    'value'=>array(
            ...
            array(
                'type'             => 'dropdown',
                'heading'          => esc_html__('Custom Column Item', 'induxe'),
            ...
            array(
                ...
                'description' => esc_html__( 'Column for each item', 'induxe' ),
                'value' => '',
                'params' => array(
                    array(
                        'type'             => 'dropdown',
...
class WPBakeryShortCode_ct_gallery_image extends CmsShortCode
{
    protected function content($atts, $content = null)
    {
        $html_id = cmsHtmlID('ct-gallery-image');
