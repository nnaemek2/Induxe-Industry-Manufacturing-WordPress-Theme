...
$args = array(
    'name'  => 'Portfolio Gallery Carousel',
    'base'  => 'ct_portfolio_gallery_carousel',
    'class' => 'ct-icon-element',
    'description' => esc_html__( 'Portfolio in Carousel', 'induxe' ),
    'category' => esc_html__('CaseThemes Shortcodes', 'induxe'),
    'params' => array(
        array(
            'type' => 'cms_template_img',
            'param_name' => 'cms_template',
            'shortcode' => 'ct_portfolio_gallery_carousel',
            'heading' => esc_html__('Shortcode Template', 'induxe'),
            'admin_label' => true,
            'std' => 'ct_portfolio_gallery_carousel.php',
        ...
        array(
            'type'       => 'autocomplete',
            'heading'    => esc_html__('Select Portfolio Categories', 'induxe'),
            'param_name' => 'source',
        ...
        array(
            'type'       => 'autocomplete',
            'class'      => '',
            'heading'    => esc_html__('Select Portfolio Name', 'induxe'),
            'param_name' => 'post_ids',
            'description' => esc_html__('Leave blank to show all Portfolio', 'induxe'),
            'settings'   => array(
                'multiple' => true,
...
class WPBakeryShortCode_ct_portfolio_gallery_carousel extends CmsShortCode
{

    protected function content($atts, $content = null)
    {
        $html_id = cmsHtmlID('ct-portfolio-gallery-carousel');
