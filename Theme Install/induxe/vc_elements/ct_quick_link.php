...
vc_map(array(
    ...
    'params' => array(
        ...
        array(
            'type' => 'param_group',
            'heading' => esc_html__( 'Quick Links', 'induxe' ),
            'value' => '',
            'param_name' => 'quick',
...
class WPBakeryShortCode_ct_quick_link extends CmsShortCode
{
