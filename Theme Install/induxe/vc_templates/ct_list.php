...
?>
<div id="ct-list-<?php echo esc_attr($uqid);?>" class="ct-lists layout1 <?php echo esc_attr( $display_item.' '.$align_list ); ?> " <?php if( !empty( $ct_list_mr_botton  )) { ?> style="margin-bottom: <?php echo esc_attr( $ct_list_mr_botton );?>" <?php } ?>>
    <div class="ct-inline-css"  data-css="
                <?php if( !empty($ct_list_color_hv)) : ?>
