...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel layout2 owl-carousel" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
                ...
                <div class="grid-item-inner">
                    ...
                    <div class="item-body">
                        ...
                        <div class="item-footer">
                            <a <?php if(!empty( $button_color )) { ?> style="background-color: <?php echo esc_attr( $button_color );?>" <?php } ?> class="btn btn-aylen" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php if(!empty($readmore_text)) { echo esc_attr($readmore_text); } else { echo esc_html__('Read More', 'induxe'); }  ?><i class="fac fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
