...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-portfolio-layout1 images-light-box <?php echo esc_attr( $select_style.' '.$el_class ); ?>">

    <div class="ct-inline-css"  data-css="<?php if( !empty($fillter_color)) : ?>
                #<?php echo esc_attr($html_id) ?>.ct-grid-portfolio-layout1 .grid-filter-inner .filter-item {
                   border-color: <?php echo esc_attr($fillter_color); ?>!important;
                   color:  <?php echo esc_attr($fillter_color); ?>!important;
                }

                #<?php echo esc_attr($html_id) ?>.ct-grid-portfolio-layout1 .grid-filter-inner .filter-item.active, 
                #<?php echo esc_attr($html_id) ?>.ct-grid-portfolio-layout1 .grid-filter-inner .filter-item:hover {
