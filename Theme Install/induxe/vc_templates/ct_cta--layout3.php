...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-cta layout3 <?php echo esc_attr( $align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?> <?php if(!empty($description)) { echo 'desc-active'; } ?>">
    ...
    <div class="ct-cta-content">
        ...
        <?php if(!empty($a_href || $button_text)) : ?><a <?php echo !empty($btn_styles) ? 'style="' . esc_attr($btn_styles) . '"' : '' ?>  class="bt-cta" href="<?php echo esc_url($a_href);?>" target="<?php  echo esc_attr($a_target); ?>"><?php endif; ?>
