...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-cta layout2 <?php echo esc_attr( $align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?> <?php if(!empty($description)) { echo 'desc-active'; } ?>">
    ...
    <div class="ct-inline-css"  data-css="
        ...
        <?php if( !empty($subtitle_color)) : ?>
            #<?php echo esc_attr($atts['html_id']);?>.ct-cta .ct-meta .ct-heading-sub {
               border-color: <?php echo esc_attr($subtitle_color); ?>!important;
            }
        <?php endif; ?>">
    ...
    <?php if(!empty($a_href || $button_text)) : ?>
        <div class="ct-meta">
            ...
            <?php endif; ?>    
            <?php if(!empty($a_href || $button_text)) : ?><a <?php echo !empty($btn_styles) ? 'style="' . esc_attr($btn_styles) . '"' : '' ?>  class="btn btn-default bt-cta" href="<?php echo esc_url($a_href);?>" target="<?php  echo esc_attr($a_target); ?>"><?php endif; ?>
                <?php echo wp_kses_post( $button_text );?>
            <?php if(!empty($a_href || $button_text)) : ?></a><?php endif; ?>        
        </div>
    <?php endif; ?>        
</div>