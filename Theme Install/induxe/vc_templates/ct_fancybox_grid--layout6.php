...
$col_sm = 12 / $col_sm;
$col_xs = 12 / $col_xs;
$fancybox_content_list = (array) vc_param_group_parse_atts( $content_list3 );
...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-fancybox layout6 <?php echo esc_attr( $congif_container ); ?>">
    <div class="ct-grid-inner row" data-gutter="15">
        <?php foreach ($fancybox_content_list as $key => $value) {
            ...
            <div class="<?php echo esc_attr($item_class); ?>">
                <div class="grid-item-inner ct-fancybox-item">
                    <?php if(!empty($image)) :
                        $img_size = isset($value['img_size']) ? $value['img_size'] : '500x357';
