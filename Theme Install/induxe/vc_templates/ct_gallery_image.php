...
extract($atts);
$tax = array();
extract(cms_get_posts_of_grid('gallery', $atts, array('gallery-category')));
...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-gallery-image images-light-box <?php echo esc_attr($el_class); ?>">
                    ...
                    <div class="grid-item-inner">
                        <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)) : ?>
                            <div class="item-featured">
                                ...
                                <a class="icon-zoom light-box" href="<?php echo wp_get_attachment_image_url( get_post_thumbnail_id( $post->ID ), $img_size = 'full') ?>">
