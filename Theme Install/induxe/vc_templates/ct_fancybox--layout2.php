...
?>
<div class="ct-fancybox-layout2 <?php echo esc_attr($el_class.' '.$animation_classes); ?>" <?php if( !empty( $margin_button.'px'  )) { ?> style="margin-bottom: <?php echo esc_attr( $margin_button.'px' );?>" <?php } ?>>
