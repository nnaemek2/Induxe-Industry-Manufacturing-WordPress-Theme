...
?>
<div id="<?php echo esc_attr($html_id) ?>" class="ct-carousel ct-portfolio-gallery-carousel layout2 owl-carousel" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
