...
$col_sm = 12 / $col_sm;
$col_xs = 12 / $col_xs;
$fancybox_content_list = (array) vc_param_group_parse_atts( $content_list2 );
...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-fancybox layout3 <?php echo esc_attr( $congif_container ); ?>">
