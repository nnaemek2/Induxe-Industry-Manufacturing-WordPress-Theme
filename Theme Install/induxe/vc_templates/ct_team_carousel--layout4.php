...
if(!empty($teams)) : ?>
    ...
    <div id="<?php echo esc_attr($html_id);?>" class="ct-team ct-team-carousel-layout4 owl-carousel" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
                                ...
                                <div class="item-social pxl-empty">
                                    <?php foreach ($el_social as $key => $value) {
                                        ...
                                        <?php if ($social_link && $icon_class ) { ?>
                                            <a href="<?php echo esc_url($social_link); ?>" target="_blank"><i class="<?php echo esc_attr( $icon_class ); ?>"></i>
                                            </a>
                                    <?php } } ?>
                                </div>
                            <?php endif; ?>
