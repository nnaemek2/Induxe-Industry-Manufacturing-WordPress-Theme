...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-service layout2 <?php echo esc_attr($el_class); ?>">
                    ...
                    <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                        <div class="grid-item-inner">
                            <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)) {
                                ...
                                ?>
                                <div class="item-featured" style="background-image: url(<?php echo esc_url($thumbnail_url[0]); ?>);">
                                </div>
                            <?php } ?>
                            <div class="item-body">
                                <div>
