...
?>
<div id="ct-service-list-<?php echo esc_attr($uqid);?>" class="ct-service-list">
    ...
    <ul>
        <?php foreach ($quick as $key => $value) { 
            ...
            if(!empty($item_title)) :?>
                <li class="ct-service-list-item" <?php if( !empty($item_post_color) ) { ?>  style="color: <?php echo esc_attr( $item_post_color );?>" <?php } ?>>
