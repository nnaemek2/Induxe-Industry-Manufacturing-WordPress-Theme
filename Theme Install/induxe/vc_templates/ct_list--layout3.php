...
?>
<div id="ct-list-<?php echo esc_attr($uqid);?>" class="ct-lists layout3" <?php if( !empty( $ct_list_mr_botton.'px'  )) { ?> style="margin-bottom: <?php echo esc_attr( $ct_list_mr_botton.'px' );?>" <?php } ?>>
