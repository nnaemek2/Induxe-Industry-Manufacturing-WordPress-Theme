...
if(!empty($teams)) : ?>
    ...
    <div id="<?php echo esc_attr($html_id);?>" class="ct-team ct-team-carousel-layout1 owl-carousel" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
                ...
                <div class="grid-item-inner">
                    ...
                    <div class="item-holder">
                        ...
                        <div class="item-info">
                            ...
                            <?php endif; ?>
                            <?php if(isset($social) && !empty($social) && count($social)): ?>
