...
?>
<div id="ct-social-us-<?php echo esc_attr($uqid);?>" class="ct-social-us layout1 <?php echo esc_attr( $style ); ?>">
    ...
    <?php if(!empty($title)) : ?>
        <h3 class="ct-social-title" <?php echo !empty($title_styles) ? 'style="' . esc_attr($title_styles) . '"' : '' ?>>
        ...
        ?>
            <li class="item-social">
                <a href="<?php echo esc_url($url)?>">
                    <i <?php if(!empty($bg_icon)) :?> style="background-color: <?php echo esc_attr( $bg_icon);?>" <?php endif;?> class="<?php echo esc_attr( $icon_class ); ?>"></i>    
                </a>
            </li>
        <?php } ?>
    </ul>
