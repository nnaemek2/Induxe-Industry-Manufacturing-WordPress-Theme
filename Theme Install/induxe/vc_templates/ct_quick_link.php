...
?>
<div id="ct-quicklink-<?php echo esc_attr($uqid);?>" class="ct-quicklink layout1 <?php echo esc_attr($style_display);?>" style="text-align: <?php echo esc_attr( $text_align);?>">
    ...
    <ul>
        <?php foreach ($quick as $key => $value) { 
            ...
            if(!empty($item_title)) :?>
                <li class="ct-quicklink-item" <?php if( !empty($item_post_color) ) { ?>  style="color: <?php echo esc_attr( $item_post_color );?>" <?php } ?>>
