...
if(!empty($fancyboxs)) : ?>
<div id="<?php echo esc_attr($html_id);?>" class="ct-fancybox-carousel layout4 owl-carousel" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
    <?php foreach ($fancyboxs as $key => $value) {
        ...
        <div class="ct-fancybox-item">
            ...
            <?php if(!empty( $title ) || !empty( $fcb_content )) : ?>
                ...
                <?php if(!empty($a_href)) : ?>
                    <a class="ct-fcb-more" href="<?php echo esc_url($a_href);?>" target="<?php  echo esc_attr($a_target); ?>">
                        <?php echo esc_html__('Read More', 'induxe'); ?>
                    </a>
                <?php endif;?>  
            <?php endif;?>
        </div>
