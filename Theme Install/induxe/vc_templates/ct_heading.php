...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-heading layout1 <?php echo esc_attr( $align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?> <?php if(!empty($description)) { echo 'desc-active'; } ?>">
    ...
    <?php if(!empty($subtitle)) : ?>
        <h6 class="ct-heading-sub subtitle" <?php echo !empty($subtitle_styles) ? 'style="' . esc_attr($subtitle_styles) . '"' : '' ?>>
            <?php echo wp_kses_post( $subtitle  ); ?>
        </h6>
    <?php endif; ?>

    <<?php echo esc_attr( $tag ); ?> class="ct-heading-tag <?php echo esc_attr( $theme_custom_fonts ); ?>" <?php echo !empty($title_styles) ? 'style="' . esc_attr($title_styles) . ' '. $inline_style .'"' : '' ?>>
