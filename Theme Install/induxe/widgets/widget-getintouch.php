...
class GetInTouch_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'getintouch_widget',
            esc_html__('* Get In Touch', 'induxe'),
            array('description' => esc_html__('Get In Touch Widget', 'induxe'),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        ?>
        <div class="contact-info widget widget-getintouch">
            <?php if(!empty($title)) : ?>
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('address_text')); ?>"><?php esc_html_e( 'Address', 'induxe' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('email_text')); ?>"><?php esc_html_e( 'Email Text', 'induxe' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('phone_text')); ?>"><?php esc_html_e( 'Phone', 'induxe' ); ?></label>
