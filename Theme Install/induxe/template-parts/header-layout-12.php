...
<header id="masthead" class="header-main">
    <div id="header-wrap" class="header-layout12 header-transparent <?php if($sticky_on == 1) { echo 'is-sticky'; } else { echo 'no-sticky'; } ?>">
                ...
                <div class="container">
                    ...
                    <?php if(!empty($h_btn_text)) : ?>
                        <div class="header-button-group">
                            <?php if(!empty($h_btn_text)) : ?>
                                <a class="btn-topbar btn-effect" href="<?php echo esc_url( $h_btn_url ); ?>" target="<?php echo esc_attr($h_btn_target); ?>"><span><?php echo esc_attr( $h_btn_text ); ?></span></a>
                            <?php endif; ?>                        
                        </div>
                    <?php endif; ?>
                </div>
