...
$ptitle_on =induxe_get_opt( 'ptitle_on', 'show');
$page_ptitle_on =induxe_get_page_opt( 'ptitle_on', 'themeoption');
if(is_page() && !empty($page_ptitle_on) && $page_ptitle_on != 'themeoption') {
	$ptitle_on = $page_ptitle_on;
} 
$ptitle_breadcrumb_on =induxe_get_opt( 'ptitle_breadcrumb_on', 'show' );
if(is_404()) {
    return true;
}
?>
